...
final class VotePopularityRuntimeTableViewCell: UITableViewCell {
    
    static let identifier = "VotePopularityRuntimeTableViewCell"
    
    static func nib() -> UINib {
        return UINib(nibName: "VotePopularityRuntimeTableViewCell", bundle: nil)
    }
    ...
    public func configure(with voteAverage: Double?, popularity: Double?) {
